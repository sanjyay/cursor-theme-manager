...
python3 tests/bundled_archive_security.test.py
...
python3 "$ROOT/scripts/cursor-import.py" install-bundled --source "$ROOT/themes/bundled/banana.tar.xz" --target "$probe_dir/home/.local/share/icons/Banana" --version 1.0 >/dev/null
