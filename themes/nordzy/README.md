...
<p align="center">
	...
	<img alt="GitLab license" src="https://img.shields.io/gitlab/license/gboehm/Nordzy-cursors?color=blue"> 
	<img alt="GitLab release (latest by date)" src="https://img.shields.io/gitlab/v/release/gboehm/Nordzy-cursors?color=9cf">
</p>
...
```
git clone https://gitlab.com/gboehm/Nordzy-cursors
cd Nordzy-cursors
```
...
Steps are identical to the [xcursors installation](https://gitlab.com/gboehm/Nordzy-cursors?tab=readme-ov-file#installer) with the --hyprcursors option added to the install script.
...
Clone the repo with git, or download `https://gitlab.com/gboehm/Nordzy-cursors/archive/refs/heads/main.zip` and extract it.
...
[Nordzy](https://github.com/MolassesLover/Nordzy-icon) icon theme. </br>
...
If you have any issues, report them [here](https://gitlab.com/gboehm/Nordzy-cursors/-/work_items), I will be happy to help you!

## How can I help ?

- By giving a **star** or **follow** on GitLab.
